...
class CelluleTest {
     ...
     */
    @Test
    void testValueCanBeRetrievedAfterBeingAdded() throws ValueAlreadyDefinedException, CellLockedException {
        Cellule cell = new Cellule();
        cell.addValueSet(new ValueSet(4));
        cell.setValue('1');
     ...
     */
    @Test
    void testValueCanBeAddedOnceWithOneValueSet() throws ValueAlreadyDefinedException, CellLockedException {
        Cellule cell = new Cellule();
        cell.addValueSet(new ValueSet(4));
     ...
     */
    @Test
    void testValueCannotBeAddedMoreThanOnceWithOneValueSet() throws ValueAlreadyDefinedException, CellLockedException {
        Cellule cell = new Cellule();
        cell.addValueSet(new ValueSet(4));
        cell.setValue('2');
     ...
     */
    @Test
    void testValueCanBeAddedOnceWithMoreThanOneValueSet() throws ValueAlreadyDefinedException, CellLockedException {
        Cellule cell = new Cellule();
        cell.addValueSet(new ValueSet(4));
        cell.addValueSet(new ValueSet(4));
     ...
     */
    @Test
    void testValueCannotBeSetMoreThanOnceWithMoreThanOneValueSet() throws ValueAlreadyDefinedException, CellLockedException {
        Cellule cell = new Cellule();
        cell.addValueSet(new ValueSet(4));
        cell.addValueSet(new ValueSet(4));
        cell.setValue('3');
     ...
     */
    @Test
    void testTwoDifferentValuesCanBeAdded() throws ValueAlreadyDefinedException, CellLockedException {
        Cellule cell = new Cellule();
        cell.addValueSet(new ValueSet(4));
        cell.addValueSet(new ValueSet(4));
        assertTrue(cell.setValue('1'));
     ...
     */
    @Test
    void testTwoCellsWithSameValueSetCannotAddSameValue() throws ValueAlreadyDefinedException, CellLockedException {
     ...
     */
    @Test
    void testTwoCellsWithSameValueSetCanAddTwoDifferentValues() throws ValueAlreadyDefinedException, CellLockedException {
        Cellule cell1 = new Cellule();
        Cellule cell2 = new Cellule();
        ValueSet vs = new ValueSet(4);
        cell1.addValueSet(vs);
